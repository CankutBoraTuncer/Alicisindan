...
public class _Favorites {
    ...
    public _Favorites(String order, String user, String description, Bitmap bitmap, int favorite, String adID) {
        this.order = order;
        this.user = user;
        ...
        try {
            ...
            for (String[] listingShowcase : listingShowcases) {
                if (listingShowcase[2] == null) {
                    ...
                    favorites.add(new _Favorites(listingShowcase[4], listingShowcase[1], listingShowcase[5], getBitmapFromEncodedString(listingShowcase[3]), R.drawable.ic_star_full, listingShowcase[2]));
